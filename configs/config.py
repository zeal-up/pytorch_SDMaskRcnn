...
class Config(metaclass=MetaConfig):
    ...
    Usage:
        ...
        """
    DEFAULT_CONFIG_FN = '' # set in runtime
    _FROZEN = False
    ...
    @classmethod
    def set_default_fn(cls, default_fn):
        cls.DEFAULT_CONFIG_FN = default_fn
    ...
    def load_default(cls):
        ...
        """
        cls._load(cls.DEFAULT_CONFIG_FN)
    ...
    @staticmethod
    def yaml_format():
        """return configs as yaml format"""
        return yaml.dump(_to_dict())
